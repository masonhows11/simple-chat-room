<div class="w-full h-svh grid lg:grid-cols-2 relative p-4 dark:bg-neutral-950">
    <section class="flex flex-col items-center justify-center gap-8">
        ...
        <header class="flex flex-col items-center  gap-2 relative">

            <p class="absolute text-white dark:text-secondary-900/80 font-black text-6xl -mt-16 ">
              سیستم ساده چت
            </p>

            <h1 class="font-bold text-white dark:text-secondary-300 text-lg mt-4 mb-4">
        ...
        <main class="w-full max-w-sm">
            <form wire:submit.prevent="submit" class="flex flex-col gap-4 w-full">
                ...
                <div>
                    <button type="submit" class="bg-blue-600 w-full px-4 py-2 rounded-md text-white
    ...
    <aside class="hidden lg:flex overflow-hidden relative items-center justify-center">
        <div class="w-full h-full overflow-hidden rounded-lg">
            <img
                ...
                src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/covers/live-chat.png') }}"
                alt=""
            >
        </div>
    </aside>
